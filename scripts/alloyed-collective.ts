...
export const scrapedItems: Item[] = [
    {
        ...
        rawCategory:
            'DamageAIBlacklistTurretBlacklistTechnologySimulacrumBlacklist',
    ...
    },
    {
        ...
        rawDescription:
            "When a skill comes off cooldown, gain a temporary barrier for 1% (+0.25% per stack) of your maximum health per second of the skill's base cooldown.",
    ...
    },
    {
        ...
        rawCategory:
            'CannotStealWorldUniqueTurretBlacklistAIBlacklistObjectiveRelatedTemporaryBlacklist',
        rawId: 'MasterBattery',
        rawDescription:
            'Contains encrypted remnants of the Collective network. Needs to be decrypted before it can be returned.',
    ...
    },
    {
        ...
        rawCategory:
            'CannotStealWorldUniqueTurretBlacklistAIBlacklistObjectiveRelatedRebirthBlacklistTemporaryBlacklist',
        rawId: 'MasterCore',
        rawDescription:
            'A swarming data nexus representing the Collective network. Can be given to a powerful entity.',
    ...
    },
    {
        ...
        rawCategory:
            'DamageSprintRelatedMobilityRelatedTechnologyAIBlacklistDevotionBlacklist',
    ...
    },
    {
        ...
        rarity: 'Boss',
        rawRarity: 'Boss (Solus Amalgamator)',
        expansion: 'Alloyed Collective',
        category: ['EquipmentRelated', 'AIBlacklist', 'Technology'],
        rawCategory: 'EquipmentRelatedAIBlacklistTechnology',
        rawId: 'ExtraEquipment',
        rawDescription:
            'Hold 1 additional equipment (+1 per stack). Press the interact and equipment buttons to cycle through held equipment.',
    ...
    },
    {
        ...
        rawId: 'Stew',
        rawDescription:
            'Increases regeneration by +2.5 (+2.5 per stack) HP/s. At full health, your regeneration is added to your base damage.',
    ...
    },
    {
        ...
        rawCategory:
            'UtilityOnKillEffectCannotStealTurretBlacklistAIBlacklistRebirthBlacklistTemporaryBlacklist',
    ...
    },
    {
        ...
        rawCategory:
            'WorldUniqueTurretBlacklistAIBlacklistObjectiveRelatedTemporaryBlacklist',
        rawId: 'PowerCube',
    ...
    },
    {
        ...
        rawDescription:
            'Increases bonus health and regeneration gains by 50% (+15% per stack) . Does not affect bonuses from leveling up.',
        image: 'Quick_Fix.png',
        position: 1160,
    },
    {
    ...
    },
    {
        ...
        rawId: 'CookedSteak',
        rawDescription:
            'Increases maximum health by 50 (+50 per stack) , plus an additional 5% (+5% per stack) of your max health.',
    ...
    },
    {
        ...
        expansion: 'Alloyed Collective',
        category: [
            'ExtractorUnitBlacklist',
            'WorldUnique',
            'TurretBlacklist',
            'ObjectiveRelated',
        ],
        rawCategory:
            'ExtractorUnitBlacklistWorldUniqueTurretBlacklistObjectiveRelated',
        rawId: 'PowerPyramid',
        rawDescription:
            'Gain +15% move speed. Can be placed in a Sentry Terminal or used for decryption.',
    ...
    },
    {
        ...
        rawId: 'UltimateMeal',
        rawDescription:
            'At full health, all random effects are rolled +2 (+2 per stack) extra times for a better outcome.',
    ...
    },
    {
        ...
        rawId: 'Parry',
        rawDescription:
            'Briefly enter a countering stance that lets you parry any and ALL damage. A successful parry nullifies incoming damage, reduces your equipment cooldown by 75%, and grants Blessing, causing your next attack to ALWAYS activate your on-hit effects.',
        type: 'Equipment',
        image: 'Deus_Ex_Machina.png',
        position: 195,
    },
];
